...
class RestaurantManagementSystem:
    ...
    def show_bill_popup(self):
        ...
        self.insert_bill_to_database()

    def insert_bill_to_database(self):
        ...
        cursor.execute("INSERT INTO bills (customer_name, customer_contact, total_price, gst_amount, grand_total) VALUES (%s, %s, %s, %s, %s)", bill_data)
    ...
    def create_database_connection(self):
        ...
        cursor.execute('''CREATE TABLE IF NOT EXISTS bills
                     (id INT AUTO_INCREMENT PRIMARY KEY, customer_name VARCHAR(255), customer_contact VARCHAR(255), total_price DECIMAL(10,2), gst_amount DECIMAL(10,2), grand_total DECIMAL(10,2))''')
